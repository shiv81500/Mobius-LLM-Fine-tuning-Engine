...
def parse_args():
    ...
    parser.add_argument("--learning-rate", type=float, default=2e-4, help="Learning rate (2e-4 recommended for small datasets)")
    parser.add_argument("--epochs", type=int, default=10, help="Number of epochs (10-20 for small datasets)")
    parser.add_argument("--batch-size", type=int, default=1, help="Batch size (kept tiny for <4GB RAM)")
    parser.add_argument("--grad-accum", type=int, default=8, help="Gradient accumulation steps")
    parser.add_argument("--max-length", type=int, default=256, help="Sequence length for tokenization (256 for Q&A)")
    parser.add_argument("--stream", action="store_true", help="Stream dataset to reduce RAM usage")
    parser.add_argument("--lora-rank", type=int, default=8, help="LoRA rank (8 for CPU efficiency)")
